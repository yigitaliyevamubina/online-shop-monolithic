...
func main() {
	...
	router.HandleFunc("/users/{page}/{limit}", handlers.ListUsers).Methods("GET")            //get list
	...
	router.HandleFunc("/products/{page}/{limit}", handlers.ListProducts).Methods("GET")            //get list
	...
	router.HandleFunc("/products/carts{page}/{limit}", handlers.ListShoppingCarts).Methods("GET")               // list all users' shopping carts
